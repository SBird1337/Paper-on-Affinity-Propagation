...
\begin{algorithm}[h!]
	...
	\KwResult{Local search minima of the energy functions for responsability and availability}
	...
	\While{No termination criterion is met}{
		Update the responsabilities according to Definition \ref{def:respupdate} with damping factor $\lambda$\;
